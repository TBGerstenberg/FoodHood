    ...
    switch(acceptedTypes){
        case "application/json":
            ...
            lib.getNextSequence("benutzerid",function(id){ 
                ...
                var PLZ = req.body.card.address.postal_code;
                ...
                lib.findDocument('distributionsgruppen',searchParams,function(result){
                    ...
                    if(result){
                        ...
                        lib.updateDocument('distributionsgruppen',{id:PLZ},GruppenUpdateParams,function(){
        ...
        case "application/json":
            ...
            async.waterfall([
                ...
                function(callback){
                    ...
                    req.body.vorschlaege=lib.generateLink("vorschlaege",id);
            ...
            async.waterfall([
                ...
                function(situation,callback){
                    ...
                    geocoder.reverseGeocode(latitudeStartstandort,longitudeStartstandort,function(err,data){
                        ...
                        //Ziehe den postal code aus der Antwort des Geocoders 
                    ...
                    var searchParams={
                        "card.address.postal-code":standortPlz
                    }
                ...
                function(standortPlz,situation,callback){    
                    ...
                    lib.findDocuments('angebote',searchparamsPLZ,function(result){
                        ...
                        //Filtere Angebote die Abholtermine im gegebenen Zeitfenster haben
                            ...
                            var spaetesterTermin;

                            //Falls ein Endzeitpunkt angegeben wurde 
                            if(situation.endzeitpunkt){
                                //und dieser nach dem Startzeitpunkt liegt
                                spaetesterTermin = new Date(situation.endzeitpunkt);
                            }

                            //Falls kein Endzeitpunkt angegeben wurde 
                            else{
                                //Setze den Endzeitpunkt gleich dem Anfangszeitpunkt 
                                spaetesterTermin = fruehesterTermin;
                            }
...
function dijkstraMitSpendenGewichtsObergrenze(distanceMatrix,situation,angebotsGeolocations,angebote,callback){
    ...
    */
    ...
    while(aktuelleAnzahlStationenDerRoute < LAENGE_DER_FERTIGEN_ROUTE-1){
        ...
        markiereKnotenSync(distanceMatrix,startknotenIndex,KNOTEN_BEREITS_IN_ROUTE);
