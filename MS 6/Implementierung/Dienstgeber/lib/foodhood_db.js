...
module.exports = {
    ...
    */
    generateLink:function(type,id){
        ...
        //Funktion wurde mit diesen Fallunterscheidungen geschrieben um bei API-Änderungen 
        //Die Links flexibel ändern zu können.
        ...
        switch(type){
            ...
            case 'sammelaktionsvorschlaege':
                return 'Benutzer/'+id+'/Situation/Sammelaktionen';
                break;
            ...
            case 'distributionsgruppe':
                return 'Distributionsgruppe/'+id;
                break;
